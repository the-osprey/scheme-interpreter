...
(begin (quote 12) (odd? 12) (/ 4))
;expect 0.25

(begin (/ 1 0) '(* 2 2))
;expect Error

(define bears (begin (display 'go )))
;expect gobears
...
***tests for Q9***
(define (bigtest a b c d e f g) (+ a b c d e f g))
;expect bigtest

(bigtest 1 2 3 4 5 6 7)
;expect 28
...
(cond
  ((= 1 3) 'duh)
  ((> 9001 9000) 'its-over-9000!!!)
  (else 'no))
;expect its-over-9000!!!
...
;the next tests test whether environments are created correctly
(define x (+ 4 2))
;expect x
...
(define berkeley (lambda (m n) (uc (/ m n))))
;expect berkeley
